...
public interface XlcDroneStatusService {
     ...
     */
    Page<XlcDroneStatusVO> page(XlcDroneStatusReq req);
     ...
     * @return VO查询结果
     */
    XlcDroneStatusVO selectByPrimaryKey(Long uavPort);
     ...
     * @return 是否更新成功
     */
    Boolean updateByPrimaryKeySelective(XlcDroneStatus record);
     ...
     * @return 影响行数
     */
    int updateByExampleSelective(XlcDroneStatus updateData, XlcDroneStatusReq condition);
     ...
     * @return 影响行数
     */
    int deleteByExample(XlcDroneStatusReq condition);
     ...
     * @return 是否新增成功
     */
    Boolean insertSelective(XlcDroneStatus record);
     ...
     * @return 是否新增成功
     */
    Boolean batchInsert(List<XlcDroneStatus> records);
